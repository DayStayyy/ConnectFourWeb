(function() {
    ...
    var ConnectFour = function() {
      ...
      async function iaPlay() {
        //console.log(gameBoard[3][0])
        //console.log(gameBoard[3][0] == 'red')
        stringBoard = boardToString();
        url = `http://127.0.0.1:8000/connectFour/api?board=${stringBoard}&player=2`
        console.log(url)
        fetch(url)
        .then(response => response.json())
        .then(response => markNextFree(response))
      }
